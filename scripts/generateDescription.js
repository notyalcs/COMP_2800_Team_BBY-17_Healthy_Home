...
db.collection("Exercise_Routines").doc("Full_Intermediate").onSnapshot(function (doc) {
    if(x == doc.data().Abdominal_Crunches[0]){
        $("#description").append("<p>" + doc.data().Abdominal_Crunches[1] + "</p>");
    }if(x == doc.data().Inchworms[0]){
        $("#description").append("<p>" + doc.data().Inchworms[1] + "</p>");
...
db.collection("Exercise_Routines").doc("Upper_Intermediate").onSnapshot(function (doc) {
    if(x == doc.data().Abdominal_Crunches[0]){
        $("#description").append("<p>" + doc.data().Abdominal_Crunches[1] + "</p>");
    }if(x == doc.data().Heel_Touch[0]){
        $("#description").append("<p>" + doc.data().Heel_Touch[1] + "</p>");
...
db.collection("Exercise_Routines").doc("Lower_Intermediate").onSnapshot(function (doc) {
    if(x == doc.data().Backward_Lunges[0]){
        $("#description").append("<p>" + doc.data().Backward_Lunges[1] + "</p>");
    }if(x == doc.data().Donkey_Kicks[0]){
        $("#description").append("<p>" + doc.data().Donkey_Kicks[1] + "</p>");
...
db.collection("Exercise_Routines").doc("Full_Advanced").onSnapshot(function (doc) {
    if(x == doc.data().Abdominal_Crunches[0]){
        $("#description").append("<p>" + doc.data().Abdominal_Crunches[1] + "</p>");
    }if(x == doc.data().Inchworms[0]){
        $("#description").append("<p>" + doc.data().Inchworms[1] + "</p>");
...
db.collection("Exercise_Routines").doc("Upper_Advanced").onSnapshot(function (doc) {
    if(x == doc.data().Abdominal_Crunches[0]){
        $("#description").append("<p>" + doc.data().Abdominal_Crunches[1] + "</p>");
    }if(x == doc.data().Heel_Touch[0]){
        $("#description").append("<p>" + doc.data().Heel_Touch[1] + "</p>");
...
db.collection("Exercise_Routines").doc("Lower_Advanced").onSnapshot(function (doc) {
    if(x == doc.data().Backward_Lunges[0]){
        $("#description").append("<p>" + doc.data().Backward_Lunges[1] + "</p>");
    }if(x == doc.data().Donkey_Kicks[0]){
        $("#description").append("<p>" + doc.data().Donkey_Kicks[1] + "</p>");
